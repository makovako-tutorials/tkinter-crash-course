...
# db.insert("Ram","John","Best buy","120")
# db.insert("Mobo","Bob","Microcenter","130")
# db.insert("CPU","John","Microcenter","140")
# db.insert("GPU","Emily","Newegg","150")
# db.insert("Ram","John","Newegg","150")
# db.insert("Mouse","Bob","Microcenter","170")
# db.insert("PSU","Emily","Nest buy","180")